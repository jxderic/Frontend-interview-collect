...
* [2.undefined 与 undeclared 的区别？](#-undefined- 与 -undeclared- 的区别)
* [3. null 和 undefined 的区别？](#-null- 和- undefined- 的区别)
* [4.JavaScript 原型，原型链？ 有什么特点？](#-JavaScript- 原型原型链有什么特点)
* [5.js 获取原型的方法？](#-js -获取原型的方法)
* [6.typeof NaN 的结果是什么？](#-typeof- NaN- 的结果是什么)
...
* [13. 如何判断一个对象是否属于某个类？](#-如何判断一个对象是否属于某个类)
* [14. js 延迟加载的方式有哪些？](#-js- 延迟加载的方式有哪些)
* [15.什么是浏览器的同源政策？](#-什么是浏览器的同源政策)
* [16.简单谈一下 cookie ？](#-简单谈一下 -cookie- )
